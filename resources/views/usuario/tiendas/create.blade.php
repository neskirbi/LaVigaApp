...
<body>
    ...
    <div class="main-content">
        <div class="row">
            <div class="col-md-12">
                <form action="{{url('tiendas')}}" method="post">
                @csrf
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="contacto" name="contacto" placeholder="Contacto">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input required type="mail" class="form-control" id="correo" name="correo" placeholder="Correo">
                                    </div>
                                </div>
                            </div>
