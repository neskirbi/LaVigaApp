                            ...
                            <div class="col-md-3" style="margin-top: 30px;">           
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-12"> 
                                                <div class="input-group mb-3">
                                                    <input type="number" class="form-control" step="0.01" min="0"  id="cantidad-{{$producto->id}}" value="0">
                                        ...
                                        <div class="row" > 
                                            <div class="col-md-12"> 
                                                <button type="button" class="btn btn-dark btn-block" onclick="AddToCart('{{$producto->id}}','{{$producto->producto}}','{{GetToken()}}')">AÑADIR AL CARRITO</button>
                                            </div>
                                        </div>
                                    </div>  
                                </div>
